...
func (node *ModU) CalculateLiveRanges(ctx context.Context) error {
...
func (node *ModU) AllocateRegisters(arch architecture.Architecture) ([]architecture.Register, error) {
